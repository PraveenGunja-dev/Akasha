  ...
  return (
    <div className="absolute right-0 top-full mt-3 w-[450px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] z-50 flex flex-col overflow-hidden max-h-[600px] transform origin-top-right transition-all">
      ...
      <div className="p-3 bg-gray-50/50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide pb-1" data-lenis-prevent="true">
      ...
      <div className="overflow-y-auto flex-1 bg-white dark:bg-gray-900" data-lenis-prevent="true">
        {isLoadingTab ? (
          <div className="p-12 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-[13px] font-medium text-gray-500">Loading {activeTab} notifications...</p>
          </div>
            ...
            {tabHasMore && (
              <div className="p-4 flex justify-center border-t border-gray-100 dark:border-gray-800">
                <button 
                  ...
                  className="px-4 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-full text-[12px] font-semibold transition-colors disabled:opacity-50"
                >
