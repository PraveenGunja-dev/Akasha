    ...
    <div className="flex flex-col h-[calc(100vh-100px)] w-full rounded-2xl border border-border/50 overflow-hidden bg-background shadow-2xl animate-in fade-in duration-500 relative">
      ...
      <div className="absolute bottom-6 left-6 z-10 flex flex-col gap-2 bg-muted/80 backdrop-blur-md p-4 rounded-xl border border-border/50 shadow-lg">
        ...
        <div className="flex items-center gap-3 text-xs text-foreground/90">
          <div className="w-3 h-3 rounded-full bg-red-500 shadow-[0_0_8px_#EF4444]"></div> Project Node
        </div>
        <div className="flex items-center gap-3 text-xs text-foreground/90">
          <div className="w-3 h-3 rounded bg-primary shadow-[0_0_8px_#3B82F6]"></div> Purchase Order Node
        </div>
        <div className="flex items-center gap-3 text-xs text-foreground/90">
          <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-b-[10px] border-b-emerald-500 drop-shadow-[0_0_8px_#10B981]"></div> Material Node
        </div>
        <div className="flex items-center gap-3 text-xs text-foreground/90">
          <div className="w-3 h-3 rounded-sm rotate-45 bg-amber-500 shadow-[0_0_8px_#F59E0B]"></div> Vendor Node
        </div>
      </div>
      ...
      <div className="flex-1 w-full h-full bg-background relative overflow-hidden cursor-move">
        ...
        <div className="absolute top-[300px] left-[400px] -translate-x-1/2 -translate-y-1/2 z-10 group cursor-pointer">
          <div className="relative flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-muted border-2 border-red-500 shadow-[0_0_20px_#EF4444] flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
        ...
        <div className="absolute top-[200px] left-[700px] -translate-x-1/2 -translate-y-1/2 z-10 group cursor-pointer">
          <div className="relative flex flex-col items-center">
            <div className="w-12 h-12 rounded bg-muted border-2 border-primary shadow-[0_0_15px_#3B82F6] flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
        ...
        <div className="absolute top-[300px] left-[900px] -translate-x-1/2 -translate-y-1/2 z-10 group cursor-pointer">
          <div className="relative flex flex-col items-center">
            <div className="w-10 h-10 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
               <div className="absolute inset-0 w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-b-[34px] border-b-emerald-500 drop-shadow-[0_0_15px_#10B981]"></div>
        ...
        <div className="absolute top-[350px] left-[150px] -translate-x-1/2 -translate-y-1/2 z-10 group cursor-pointer">
          <div className="relative flex flex-col items-center">
            <div className="w-14 h-14 bg-muted border-2 border-amber-500 rounded-lg rotate-45 shadow-[0_0_15px_#F59E0B] flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
