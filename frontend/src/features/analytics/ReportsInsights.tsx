      ...
      <div id="executive-report" className="bg-white text-black rounded-2xl p-10 shadow-sm">
        ...
        <div className="flex justify-between items-start border-b border-border pb-6 mb-8">
          ...
          <div className="text-right">
            <p className="text-sm text-foreground font-mono">DATE: {new Date().toLocaleDateString()}</p>
            <p className="text-sm text-foreground font-mono">TIME: {new Date().toLocaleTimeString()}</p>
            <p className="text-sm text-success font-mono mt-2 flex items-center justify-end gap-1">
        ...
        {/* Document Body */}
        <div className="space-y-6 text-foreground leading-relaxed text-justify">
        ...
        {/* Signatures */}
        <div className="mt-12 pt-8 border-t border-border flex justify-between html2pdf__page-break-inside-avoid">
          <div className="w-48">
            <div className="border-b border-gray-400 mb-2 h-8"></div>
            <p className="text-xs text-muted-foreground uppercase tracking-wider text-center">Generated by</p>
            <p className="text-sm text-black font-medium text-center">Ask Akasha</p>
          </div>
          <div className="w-48">
            <div className="border-b border-gray-400 mb-2 h-8"></div>
            <p className="text-xs text-muted-foreground uppercase tracking-wider text-center">Reviewed by</p>
